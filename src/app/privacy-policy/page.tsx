  ...
  return (
    ...
    >
      <div className="container relative z-10">
        ...
        <div className="prose prose-lg dark:prose-dark max-w-4xl mx-auto text-justify">
          <p>
          ...
          <ul>
            ...
            <li>
              <strong>Company:</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Speeir Limited, Athlone, Ireland.
            </li>
            <li>
              <strong>Cookies:</strong> Small files placed on Your computer, mobile device, or any other device by a website, containing the details of Your browsing history on that website among its many uses.
            </li>
            <li>
            ...
            <li>
              <strong>Website:</strong> Refers to Speeir, accessible from{' '}
              <Link href="https://speeir.com/" passHref legacyBehavior>
                <a className="text-blue-600 hover:underline" target="_blank" rel="external nofollow noopener">
                  https://speeir.com/
                </a>
              </Link>
            </li>
          ...
          <ul>
            ...
            <li>
              <strong>Functionality Cookies:</strong> These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You use the Website.
            </li>
          </ul>
          <p>
          ...
          <ul>
            <li>
              By email: <a href="mailto:info@speeir.com" className="text-blue-600 hover:underline">info@speeir.com</a>
            </li>
            <li>
