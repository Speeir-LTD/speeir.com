    ...
    <>
      ...
      <section className="relative overflow-hidden py-16 md:py-20 lg:py-28 bg-gradient-to-b from-white to-gray-50/50 dark:from-gray-900 dark:to-gray-900/90">
        ...
        <div className="absolute inset-0 overflow-hidden opacity-10 dark:opacity-20">
          <div className="absolute top-1/4 left-1/4 w-32 h-32 rounded-full bg-blue-400 animate-[float_8s_ease-in-out_infinite] mix-blend-multiply dark:mix-blend-screen"></div>
          <div className="absolute bottom-1/3 right-1/4 w-40 h-40 rounded-full bg-purple-400 animate-[float_10s_ease-in-out_infinite_reverse] mix-blend-multiply dark:mix-blend-screen"></div>
          <div className="absolute top-3/4 left-3/4 w-24 h-24 rounded-full bg-emerald-400 animate-[float_12s_ease-in-out_infinite] mix-blend-multiply dark:mix-blend-screen"></div>
        </div>

        {/* Geometric pattern overlay */}
        <div className="absolute inset-0 opacity-5 dark:opacity-10">
          <div className="absolute inset-0 bg-[url('/images/patterns/grid.svg')] bg-[length:80px_80px]"></div>
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 h-40">
          <div className="relative h-full w-full">
            <div className="absolute left-[10%] bottom-0 h-24 w-24 animate-[float_6s_ease-in-out_infinite] rounded-2xl bg-gradient-to-br from-blue-500/20 to-purple-500/20 shadow-lg backdrop-blur-sm mix-blend-multiply dark:mix-blend-screen"></div>
            <div className="absolute right-[10%] bottom-10 h-16 w-16 animate-[float_8s_ease-in-out_infinite_reverse] rounded-xl bg-gradient-to-br from-pink-500/20 to-rose-500/20 shadow-lg backdrop-blur-sm mix-blend-multiply dark:mix-blend-screen"></div>
            <div className="absolute left-[40%] bottom-20 h-20 w-20 animate-[float_10s_ease-in-out_infinite] rounded-2xl bg-gradient-to-br from-emerald-500/20 to-teal-500/20 shadow-lg backdrop-blur-sm mix-blend-multiply dark:mix-blend-screen"></div>
          </div>
        </div>
      </section>
    </>
