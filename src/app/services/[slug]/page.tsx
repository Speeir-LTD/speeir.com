  ...
  if (!service) {
    return (
      <div className="container mx-auto py-16 px-4 text-center">
        ...
        <Link href="/services" className="bg-primary text-white px-6 py-3 rounded-md hover:bg-primary/90">
          View all services
        </Link>
      </div>
    );
    ...
    <div className="container mx-auto py-16 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center mb-8">
          <div className="mr-6 text-primary w-16 h-16">
            {service.icon}
          </div>
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <div className="mt-12 p-6 bg-gray-50 dark:bg-gray-800 rounded-lg">
            ...
            <Link href="/contact" className="inline-block bg-primary text-white px-6 py-3 rounded-md hover:bg-primary/90">
              Contact Us
            </Link>
          </div>
        </div>
