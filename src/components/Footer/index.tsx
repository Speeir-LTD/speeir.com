            ...
            <div className="flex items-center space-x-6">
              {[
                ...
                { 
                  ...
                  url: "https://www.facebook.com/profile.php?id=61576228562819" 
                },
              ].map((social) => (
                <a
                  key={social.name}
                  ...
                  className="group relative text-gray-600 transition-all duration-300 hover:text-primary dark:text-gray-300 dark:hover:text-primary hover:scale-110"
                >
                  <div className="absolute -inset-2 rounded-full bg-gradient-to-r from-blue-500/20 to-purple-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-sm"></div>
                  <svg className="relative h-6 w-6 fill-current transition-transform duration-300 group-hover:rotate-12" viewBox="0 0 24 24">
                    <path d={social.icon} />
                  </svg>
                </a>
              ))}
